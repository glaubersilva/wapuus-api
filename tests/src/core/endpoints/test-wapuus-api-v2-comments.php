...
/**
 * Tests for the Wapuus API V2 "comments" resource.
 *
 * @package Wapuus_API
...
if ( ! class_exists( 'Wapuus_API_V2_Comments_Tests' ) ) {

	/**
	 * Tests Class.
	 */
	class Wapuus_API_V2_Comments_Tests extends Unit_API_Test_Case {
