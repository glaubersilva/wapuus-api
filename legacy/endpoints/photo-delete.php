...
function gs_api_photo_delete( $request ) {
...
function gs_register_api_photo_delete() {
	...
	register_rest_route(
		...
		array(
			...
			'callback' => 'gs_api_photo_delete',
		)
	);

}
add_action( 'rest_api_init', 'gs_register_api_photo_delete' );
